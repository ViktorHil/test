...
# 1 "/usr/include/c++/5/bits/c++0x_warning.h" 1 3
# 36 "/usr/include/c++/5/array" 2 3
# 6 "Test.cpp" 2
...
# 7 "Test.cpp" 2
# 1 "/usr/include/c++/5/unordered_map" 1 3
# 32 "/usr/include/c++/5/unordered_map" 3
       
# 33 "/usr/include/c++/5/unordered_map" 3
# 8 "Test.cpp" 2
# 1 "/usr/include/c++/5/thread" 1 3
# 32 "/usr/include/c++/5/thread" 3
       
# 33 "/usr/include/c++/5/thread" 3
# 9 "Test.cpp" 2
...
int main( int argc, char* argv[]) {
    std::thread* th[4];
    for( int i = 0; i < 4; i++) {
 th[i] = new std::thread( th_func2, i, 10000000/4);
    }
